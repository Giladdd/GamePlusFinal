...
<body class="fullPage">
    ...
    <?php 
        if(!empty($_POST["Submit"])) {
            $query = "UPDATE tbl_204_user_in_game SET rank=".$_POST["rank"].", ign='".$_POST["username"]."' WHERE game_id=".$game_id." AND user_id=". $_SESSION["user_id"];
            mysqli_query($connection, $query);
            header('Location: '.'gamepage.php?game_id=' . $game_id);
        }
        $query2= 'SELECT * FROM tbl_204_user_in_game WHERE game_id='.$game_id.' AND user_id='. $_SESSION["user_id"];
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active" aria-current="page" href="home.php">Looking for player</a>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="username" value=" <?php echo $row["ign"]; ?>" name="username" placeholder="username">
                ...
                <div class="col">
                    <div class="form-floating">
                        <input type="number" class="form-control" id="rank" value="<?php echo $row["rank"]; ?>"name="rank" placeholder="rank" step="1" min="1" max="150">
