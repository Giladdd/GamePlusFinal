...
<body class="fullPage">
    ...
    <?php 
        if(!empty($_POST["Submit"])) {
            $query = 'INSERT INTO tbl_204_game (game_name, game_description, game_picture, category_id) VALUES ("'.$_POST["gamename"].'", "'.$_POST["description"].'", "'.$_POST["picture"].'", '.$_POST["category_id"].')';
            ...
            <div class="row">
                <div class="col">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="gamename" name="gamename" placeholder="gamename">
